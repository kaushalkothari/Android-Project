...
public class BasicTraversal extends Activity{
	protected void onCreate(Bundle savedInstanceState) {
		...
		view1.loadUrl("file:///android_asset/traversal_theory.html");
		
		 WebView view2= (WebView) findViewById(R.id.examplewebview);
			view2.setVerticalScrollBarEnabled(false);
			view2.loadUrl("file:///android_asset/traversal_example.html");		       

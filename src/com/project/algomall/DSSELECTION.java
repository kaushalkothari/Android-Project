...
public class DSSELECTION extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_dsselection);
		...
		b3=(Button)findViewById(R.id.btnselection);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.dsselection, menu);
		return true;
	}
...
int j1;
		...
		for(int i=0;i<num.size()-1;i++)
		{
          for(j1=i+1;j1<num.size();j1++)
          {
			...
			if(num.get(i)>num.get(j1))
			{
				int temp=num.get(i);
				num.set(i, num.get(j1));
				num.set(j1, temp);
				swap=true;

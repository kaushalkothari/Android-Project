...
public class DivideAndConquer extends Activity{
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.divideandconquer_web);
		...
		view1.loadUrl("file:///android_asset/divideandconquer_theory.html");
		
		 WebView view2= (WebView) findViewById(R.id.examplewebview);
			view2.setVerticalScrollBarEnabled(false);
			view2.loadUrl("file:///android_asset/divideandconquer_example.html");		       
